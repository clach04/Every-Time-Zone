...
(function() {
    ...
    // Get UTC offset in hours for a data row at a given date
    ...
    v = [], q = 0, bt = function(e) {
        ...
        if (!st) return L("shortcut_link", "link to this page");
        ...
        l = 115, i = 0, t = kt / 2 - a / 2, f = "", r = "", s = "", o = [], ut = [], c = function(e) {
            var n, u, offset;
            return offset = getOffsetForRow(e, w), n = -offset / 24 * a, u = i * Q + l, o.push([{
                left: n + t - a * 2,
                top: u + 20,
                ...
                left: n + t - a,
                top: u + 20,
                gradient: C(offset, offset + 24 + q / 60)
            }, {
                left: n + t,
                top: u + 20,
                gradient: C(offset, offset + q / 60)
            }, {
                left: n + t + a,
                top: u + 20,
                gradient: C(offset, offset - 24 + q / 60)
        ...
        for (n = 0, r = v.length; n < r; n++) e = v[n], i.push(function(e) {
            var n, r, i, s, u, a, offset;
            return offset = getOffsetForRow(e, w), n = o[t], r = C(offset, offset + 48 + q / 60), i = C(offset, offset + 24 + q / 60), s = C(offset, offset + q / 60), u = C(offset, offset - 24 + q / 60), a = C(offset, offset - 48 + q / 60), n[1].gradient !== i && x(n[1].left, n[1].top, n[1].gradient = i), n[2].gradient !== s && x(n[2].left, n[2].top, n[2].gradient = s), n[3].gradient !== u && x(n[3].left, n[3].top, n[3].gradient = u), t += 1
        }(e));
        return i
    }, V = function() {
        ...
        var t;
        return t = Z(), O = !0, location.hash = t, e("shortcut_link").setAttribute("href", "#" + t)
